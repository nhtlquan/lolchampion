...
public class MatchDetailRightAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Parcelable {
    ...
    public MatchDetailRightAdapter(Context context, List<MatchParticipant> lstData, int numberColmns) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_right_match_history_detail, parent, false);
    ...
    private class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void init(final MatchParticipant item, int po) {
            try {
                ...
                tv_player_name_team_1.setText(item.getParticipantIdentities().getPlayer().getSummonerName());
