...
public class ItemHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Parcelable {
    ...
    public ItemHistoryAdapter(Context context, List<String> lstData, int numberColmns) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_into_history_item, parent, false);
