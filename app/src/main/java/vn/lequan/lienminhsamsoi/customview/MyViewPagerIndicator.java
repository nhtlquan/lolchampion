package vn.lequan.lienminhsamsoi.customview;
...
public class MyViewPagerIndicator extends View implements PageIndicator {
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C08361();
        int currentPage;

        static class C08361 implements Creator<SavedState> {
            C08361() {
            }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.mViewPager != null) {
            ...
            float threeRadius = this.mRadius * ((float) this.space);
